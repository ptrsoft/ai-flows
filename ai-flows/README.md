...
ASTRA_DB_CLIENT_ID=your_client_id_here
ASTRA_DB_CLIENT_SECRET=your_client_secret_here
...
KAYAKO_PASSWORD=your-password-here
...
LLAMACLOUD_ORG_ID=your_llamacloud_org_id_here
LLAMACLOUD_PROJECT_NAME=your_project_name_here
LLAMACLOUD_INDEX_NAME=your_index_name_here
```
